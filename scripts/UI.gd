...
func _ready():
    ...
    if is_instance_valid(player_node):
        ...
        if "min_travel_speed" in player_node and "max_travel_speed" in player_node:
            speed_meter.max_value = player_node.max_travel_speed
            speed_meter.min_value = player_node.min_travel_speed
        else:
        ...
        var initial_speed = player_node.travel_speed if "travel_speed" in player_node else speed_meter.min_value
